...
const ledger_path = process.env.PCODX_LEDGER_PATH ?? `/tmp/pcodx-ledger-${process.pid}.json`
    ...
    content: [
      {
        ...
        text: [
          ...
          "Use partial_compact_record_message for important context you may later compact.",
          "Use partial_compact_current_session_message_ids to see visible message and compaction ids.",
          "Use partial_compact with from_message_id, to_message_id, and a faithful summary to replace a contiguous recorded range.",
