...
All v0 design choices are now locked.
Historical record of how each was decided.
...
OQs the Opus critique surfaced that we acknowledge but don't address in v0:
...
- OQ-16 (PartID/MessageID format upgrade path — handled by
    major version bump).
